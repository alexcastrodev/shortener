...
import { needsStrictCsp, strictCsp } from './utils/content-security-policy';

export const streamTimeout = 5_000;

// Default React Router server entry, plus a per-request CSP nonce for the
// public pages that render user content (see content-security-policy.ts).
